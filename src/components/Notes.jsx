...
import { showNote, toggleImportance, upvote } from '../reducers/noteReducer/noteReducer';
import { setNotification } from '../reducers/notificationReducer/notificationReducer';
import { nextPage, previousPage } from '../reducers/paginationReducer/paginationReducer';
    ...
    <ul>
      ...
      .map(note =>
        ...
        <Note
          ...
          note={note}
          handleClick={() => 
            dispatch(toggleImportance(note.id, notes))
          }
